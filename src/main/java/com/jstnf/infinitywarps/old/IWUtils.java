...
import com.jstnf.infinitywarps.old.command.commands.*;
import com.jstnf.infinitywarps.old.command.commands.infinitywarps.ImportesswarpsSubcommand;
import com.jstnf.infinitywarps.old.command.commands.infinitywarps.InfinitywarpsCommand;
import com.jstnf.infinitywarps.old.command.commands.manwarp.EditwarpCommand;
import com.jstnf.infinitywarps.old.command.commands.warpgroup.*;
import com.jstnf.infinitywarps.old.database.Warp;
import com.jstnf.infinitywarps.old.database.WarpGroup;
import com.jstnf.infinitywarps.old.inventory.DefinitionType;
import com.jstnf.infinitywarps.old.inventory.InventoryDefinition;
...
public class IWUtils
{
	...
	public static void setupListeners(IWMain plugin)
	{
		...
		EditwarpCommand editwarpc = new EditwarpCommand(plugin);
		...
		plugin.getCommand("manwarp").setExecutor(editwarpc);
